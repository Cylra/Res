...
public class Demo extends JFrame{
    ...
    public Demo(){
        ...
        this.setTitle("基于IPv6的多路径传输技术网络直播平台");
       JPtop = new JPanel(new GridLayout(5,4,2,5)); 
      
       JPcenter = new JPanel(new BorderLayout());
       TitledBorder bo1 = new TitledBorder("输出");
       ...
       JLAdd = new JLabel("服务器地址:",SwingConstants.RIGHT);
       JLProtocol = new JLabel(" 协议:",SwingConstants.RIGHT);
       JLScence = new JLabel("场景:",SwingConstants.RIGHT);
       JLPort = new JLabel("端口:",SwingConstants.RIGHT);
       
       
      // JLBan = new JLabel("");
       JLEmpty1 = new JLabel(" ");
       //
       JIP = new JButton("IP查询");
       ...
       JBBan1 = new JButton("禁用");
       
       JBStart = new JButton("播放");
       JBStart.setPreferredSize(new java.awt.Dimension(0,0));
       
       JBReset = new JButton("重置");
       JBliu = new JButton("流量监控");
       JBlu =new JButton("链路查询");
...
//actionListener
    ...
    private class CmdProc implements ActionListener
    {
            ...
            public void actionPerformed(ActionEvent e)
            {
                    //如何获取可编辑的下拉菜单的当前值？？？？然后赋值给cmd！！！ gnome-terminal -x ls|less
                    //String cmd = "gnome-terminal -x ffplay rtmp://"+(String)jcbAdd.getSelectedItem()+":1935/live/livestream;bash";
                    //String cmd = "bwm-ng";
                    String cmd = "gnome-terminal -x /home/long/下载/client/Demo/a";
